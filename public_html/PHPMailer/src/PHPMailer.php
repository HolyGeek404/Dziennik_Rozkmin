<?php
    ...
    class PHPMailer
    {
        ...
        /**
         * Set the public_html and private key files and password for S/MIME signing.
         *
        ...
        /**
         * Allows for public_html read access to 'to' property.
        ...
        /**
         * Allows for public_html read access to 'cc' property.
         * Before the send() call, queued addresses (i.e. with IDN) are not yet included.
         *
         * @return array
         */
        ...
        /**
         * Allows for public_html read access to 'bcc' property.
         * Before the send() call, queued addresses (i.e. with IDN) are not yet included.
         *
         * @return array
         */
        ...
        /**
         * Allows for public_html read access to 'ReplyTo' property.
         * Before the send() call, queued addresses (i.e. with IDN) are not yet included.
         *
         * @return array
         */
        ...
        /**
         * Allows for public_html read access to 'all_recipients' property.
         * Before the send() call, queued addresses (i.e. with IDN) are not yet included.
         *
         * @return array
         */
